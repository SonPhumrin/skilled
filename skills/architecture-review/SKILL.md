...
Once the user picks a candidate, call the Skill tool with "requirements-interview" to walk the decision tree with them: constraints, dependencies, the shape of the deepened module, what sits behind the seam, what tests survive.
...
- **Want to explore alternative interfaces for the deepened module?** Call the Skill tool with "module-design" and use its design-it-twice parallel sub-agent pattern.
