...
Both end in a proposal awaiting the user's explicit confirmation, not an implicit green light. Once confirmed, don't start editing files directly: route through `skilled`'s main flow, using the chain decision below.
